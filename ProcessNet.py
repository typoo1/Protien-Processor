...
fileName = 'RawData_179_330_4.csv'
guanFileName = 'GuanRaw.csv'
...
data  =  pd.read_csv(fileName, skiprows = 12, encoding = "ISO-8859-1")
...
guanData =  pd.read_csv(guanFileName, encoding = "ISO-8859-1")
...
for i, row in enumerate(unfoldRows.iterrows()):
    ...
    plt.savefig('C:/Users/TyeG/CSProject/app/uploads/unfoldPlot_' + str(i) + '.png', bbox_inches='tight')
    plt.close()
...
plt.savefig('unfoldCorrelation.png', bbox_inches='tight')
plt.close()
...
plt.savefig('allUnfolds.png', bbox_inches='tight')
plt.close()
